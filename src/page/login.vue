	...
	<div >
		...
		<section class="deng_d_errt" id="seek_apper">
			<p class="pd tr">
				...
				<i class="f_i colose_ddrt " @tap="hf('')"></i>
			</p>
			...
			<section class="sd_ih_Cde pt30">
				...
				<section class="mt40">
					...
					<p class="mt15" @click="hf('register_zhu')">
        ...
        data() {
            return {
                ...
                test: {
                    ...
                    "expires_in": 6938.025,
                    "access_token": "13_DAeC-fuSxHZX8PmGvWuDXVdYUIChoX4gfTv-Wj_8iwT-hoCzAM2VIV6MkvDe3WQGbZcf8Y0nPauhTWe5qlF8posMMCVPSaOIDVPm2ypFz1I",
                        ...
                        if (!s.authResult) {
                            s.login(
                                function(e) {
                                    ...
                                    th.sd_eerert.target.authResult.accessToken =
                                        df_der.access_token;
