    ...
    <div>
        ...
        <div class="mui-content " id="seek_apper">
            <van-cell-group>
                ...
                <van-cell title="下单时间">
                    <span class="z9">{{sd.validBegainTime}}</span>
                </van-cell>

                <van-cell title="项目名称">
                    <span class="z9">{{sd.projectName}}({{(sd.cardName)}})</span>
                </van-cell>

                <van-cell title="数量">
                    <span class="z9">{{sd.ticketNum}}</span>
                </van-cell>

            </van-cell-group>
            <section class="pd pt20 pm10 bgff " style="position:'fixed',bottom:0;">
        <van-button type="primary" class="fz16 w100" >付款</van-button>
        <van-button type="default" class="fz16 w100 mt10">取消</van-button>
        </section>
